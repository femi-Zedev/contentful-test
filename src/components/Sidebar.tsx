...
export default function Sidebar( ) {
  ...
  return (
    ...
    <div
      className={`w-full mb-6 lg:mb-0 mx-auto relative  text-center px-6 rounded-[20px] mt-[180px] md:mt-[220px] lg:mt-0 ${colorScheme == 'dark' ? "bg-white" : "bg-[#111111]"}`} >
      ...
      <div className="pt-[100px] pb-8">
        ...
        <h3
          className={`mb-4 inline-block px-5 py-1.5 rounded-lg ${colorScheme == 'dark' ? "text-[#7B7B7B]" : "bg-[#1D1D1D] text-[#A6A6A6]"}`}>
          Ui/Ux Designer </h3>
